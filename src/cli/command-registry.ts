...
export const COMMAND_REGISTRY: CommandEntry[] = [
  ...
  {
    name: 'earn add-liquidity',
    action: null,
    category: 'Trading',
    description: 'Add liquidity to pool',
    helpFormat: 'earn add-liquidity $100',
    parameterized: true,
  },
  {
    name: 'earn remove-liquidity',
    action: null,
    category: 'Trading',
    description: 'Remove liquidity from pool',
    helpFormat: 'earn remove-liquidity 50%',
    parameterized: true,
  },
  {
    name: 'earn stake',
  ...
  },
  {
    ...
    category: 'Trading',
    description: 'View earn/LP status',
    aliases: ['earn status'],
    hidden: true,
  },
  {
