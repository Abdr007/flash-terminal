...
export const COMMAND_REGISTRY: CommandEntry[] = [
  ...
  },
  {
    ...
    category: 'Utilities',
    description: 'Live market table',
    aliases: ['watch', 'market monitor'],
  },
  {
    name: 'monitor protocol',
    action: null,
    category: 'Utilities',
    description: 'Protocol health monitor',
  },
  {
    name: 'monitor position',
    action: null,
    category: 'Utilities',
    description: 'Track position PnL & risk',
    helpFormat: 'monitor position <mkt>',
    parameterized: true,
  },
  {
    name: 'monitor liquidations',
    action: null,
    category: 'Utilities',
    description: 'Liquidation cluster alerts',
    helpFormat: 'monitor liquidations <mkt>',
    parameterized: true,
  },
  {
    name: 'watch',
    action: null,
    category: 'Utilities',
    description: 'Auto-refresh any command',
    helpFormat: 'watch <command>',
    parameterized: true,
  },
  {
